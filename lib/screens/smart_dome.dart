...
import 'package:resto_lights/widget/select_vehicle_top.dart';
import 'package:resto_lights/widget/select_color.dart';

class SmartDome extends StatefulWidget {
  const SmartDome({Key? key}) : super(key: key);

  @override
  State<SmartDome> createState() => _SmartDomeState();
}

class _SmartDomeState extends State<SmartDome> {
